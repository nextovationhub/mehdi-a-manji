                        ...
                        <div className="container-fluid clearfix inner-bar">
                            ...
                            <div className={`header-nav w3menu w3menu-end mo-left ${show === 2 ? 'show' : ''}`} id="W3Menu">
                                ...
                                <ul className="nav navbar-nav">
                                    ...
                                    <div className="d-block d-lg-none mt-3 px-3">
                                        <Link
                                            href="https://portal.labcloud.pk/reports"
                                            className="btn btn-primary btn-hover1 w-100 text-center"
                                            style={{
                                ...
                                {/* <div className="dz-social-icon">
                                    <ul>
                                        ...
                                        <li> <Link href="https://x.com/" target="_blank"> <i className="fa-brands fa-x-twitter" /> </Link> </li>
                                        <li> <Link href="https://www.linkedin.com/showcase/" target="_blank"> <i className="fa-brands fa-linkedin" /> </Link> </li>
                                ...
                                <div className="extra-cell">
                                    <ul className="header-right">
                                        <li className="nav-item">
                                            <Link href="https://portal.labcloud.pk/reports" className="btn btn-primary btn-hover1"> View Reports </Link>
                                        </li>
                ...
                <div className={`offcanvas dz-offcanvas offcanvas offcanvas-end ${show === 1 ? 'show' : ''}`} tabIndex={-1} id="headerSidebar">
                    ...
                    <div className="offcanvas-body">
                        <div className="widget">
                            ...
                            <p>Dr. Mehdi A. Manji is a modern and responsive Bootstrap HTML template designed for health and medical websites. Ideal for clinics, hospitals, and healthcare professionals seeking a professional online presence with an elegant and user-friendly design.</p>
                        </div>
                        <div className="widget">
                            ...
                            <ul className="list-check">
                                ...
                                <li><Link href="mailto:info@drmanjilab.pk" className="text-body">info@drmanjilab.pk</Link></li>
                                <li><Link href="http://wa.me/923272255666" className="text-body">0327-2255666</Link></li>
                            </ul>
                        </div>
                        <div className="widget">
                            <div className="widget-title">
                        ...
                        <div className="widget">
                            ...
                            <div className="dz-social-icon style-1">
                                <ul>
                                    ...
                                    <li><Link href="https://www.facebook.com/ " target="_blank"><i className="fa-brands fa-facebook-f" /></Link> </li>
                                    <li><Link href="https://x.com/ " target="_blank"><i className="fa-brands fa-x-twitter" /></Link> </li>
                                    <li><Link href="https://www.youtube.com/@ " target="_blank"><i className="fa-brands fa-youtube" /></Link> </li>
                                </ul>
                            </div>
                        </div>
                    </div>
