                                    ...
                                    <div className="widget widget_info bg-light wow fadeInUp" data-wow-delay="0.3s" data-wow-duration="0.7s">
                                        ...
                                        <div className="icon-bx-wraper style-1 m-b20">
                                            ...
                                            <div className="icon-content">
                                                ...
                                                <p className="fw-normal"><Link href="http://wa.me/923272255666" className="text-body">0327-2255666</Link></p>
                                            </div>
                                        </div>
                                        <div className="icon-bx-wraper style-1 m-b15">
                                            ...
                                            <div className="icon-content">
                                                ...
                                                <p className="fw-normal"><Link href="mailto:info@drmanjilab.pk" className="text-body">info@drmanjilab.pk</Link></p>
                                            </div>
                                        </div>
                                    </div>
                                </aside>
